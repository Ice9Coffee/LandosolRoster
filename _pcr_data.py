...
CHARA_NAME = {
    ...
    1230: ["爱梅斯", "アメス", "Amesu", "Ameth", "菲欧", "爱美斯", "艾美斯", "艾梅斯"],
    ...
    1319: ["爱蜜莉雅(夏日)", "エミリア(サマー)", "Emilia(Summer)", "水emt", "水莉雅"],
    1320: ["艾姬多娜(夏日)", "エキドナ(サマー)", "Echidna(Summer)", "强欲魔女", "贪婪魔女"],
    1321: ["雷姆(夏日)", "レム(サマー)", "Rem(Summer)", "水蕾姆", "水雷姆"],
    # =================================== #
