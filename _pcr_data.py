...
CHARA_NAME = {
    ...
    1069: ["霸瞳皇帝", "カイザーインサイト", "Mana", "Kaiser Insight", "真那", "千里真那", "千里", "霸瞳", "霸铜"],
    ...
    1298: ["真琴(指挥官)", "マコト(コマンダー)", "Makoto(Commander)", "CoMakoto", "真琴(教官)", "战狼", "指狼", "指琴"],
    1299: ["惠理子(指挥官)", "エリコ(コマンダー)", "Eriko(Commander)", "CoEriko", "惠理子(教官)", "战病", "病教", "娇官", "指病", "军病"],
    ...
    1380: ["薇欧莉特(伊邪那美)", "ヴァイオレット(イサナミ)", "薇奥莉特(伊邪那美)", "水紫罗兰", "水紫"],
    #1381: ["莱拉耶尔()", "ライラエル()"],
    #1382: ["涅妃·涅罗()", "ネフィ＝ネラ()", "涅妃＝涅菈()"],
    # =================================== #
    ...
    1808: ["禊&美美&镜华", "ミソギ&ミミ&キョウカ", "Misogi&Mimi&Kyouka", "LLTrio", "未奏希&美美&镜华", "小小甜心", "狱三家", "小御三家"],
