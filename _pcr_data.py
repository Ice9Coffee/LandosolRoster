...
CHARA_NAME = {
    ...
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "Ameth(Summer)", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝", "水菲欧"],
    ...
    1337: ["拉比林斯达(始原)", "ラビリスタ(アルファ)", "Labyrista(Alpha)", "菈比莉斯塔(始原)", "原晶"],
    1338: ["似似花(始原)", "ネネカ(アルファ)", "Neneka(Alpha)", "原花"],
    1339: ["克莉丝提娜(始原)", "クリスティーナ(アルファ)", "Kurisutiina(Alpha)", "原克"],
    # =================================== #
