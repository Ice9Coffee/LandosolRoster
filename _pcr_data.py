...
CHARA_NAME = {
    ...
    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "Inori(TimeTraveller)", "TTInori", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八"],
    ...
    1168: ["珠希(作业服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "Tamaki(Work)", "WTamaki", "珠希(工作服)", "工猫贼", "工猫剑", "工贼", "工珠希"],
    ...
    1261: ["普蕾西亚(堕落)", "プレシア(フォールン)", "Precia(Fallen)", "FPrecia", "普雷西娅(堕天使)", "普蕾西亚", "猪妹"],
    ...
    1275: ["咲恋(萨拉萨利亚)", "サレン(サラサリア)", "Saren(Salasaria)", "SaSaren", "火电", "火电站", "火舞旋风", "沙电"],
    1276: ["流夏(萨拉萨利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "SaRuka", "流沙", "沙漠流夏"],
    1277: ["琳德", "リンド", "Lind", "龙姐"],
    ...
    1337: ["拉比林斯达(始原)", "ラビリスタ(アルファ)", "Labyrista(Alpha)", "ALabyrista", "菈比莉斯塔(始原)", "原晶", "α晶"],
    1338: ["似似花(始原)", "ネネカ(アルファ)", "Neneka(Alpha)", "ANeneka", "原花", "α花"],
    1339: ["克莉丝提娜(始原)", "クリスティーナ(アルファ)", "Kurisutiina(Alpha)", "AChristina", "原克", "α克"],
    1340: ["菲欧", "フィオ", "Fio"],
