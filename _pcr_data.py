...
CHARA_NAME = {
    ...
    1025: ["铃莓", "スズメ", "Suzume", "女仆", "妹抖","Umb","悠木碧","雀"],
    1026: ["铃", "リン", "Rin", "松鼠", "🐿", "🐿️"],
    1027: ["惠理子", "エリコ", "Eriko", "病娇"],
    1028: ["咲恋", "サレン", "Saren", "充电宝", "青梅竹马", "幼驯染", "院长", "大小姐","园长", "🔋", "普电"],
    ...
    1061: ["矛依未", "ムイミ", "Muimi", "诺维姆", "Noemu", "夏娜", "511", "无意义", "天楼霸断剑", "披风大剑侠","姆咪", "母咪"],

    1063: ["亚里莎", "アリサ", "Arisa", "鸭梨瞎", "瞎子", "亚里沙", "鸭梨傻", "亚丽莎", "亚莉莎", "瞎子弓", "🍐🦐", "yls"],
    1064: ["雪菲", "シェフィ", "Shephy", "Shefi", "紫布菜","冰龙"],
    1065: ["嘉夜", "カヤ", "Kaya", "憨憨龙", "龙拳", "🐲👊🏻", "🐉👊🏻", "接龙笨比", "鬼道嘉夜","卡雅","卡亚","卡姐","卡娅"],
    1066: ["祈梨", "イノリ", "Inori", "梨老八", "李老八", "龙锤", "🐲🔨"],
    1067: ["帆稀", "ホマレ", "Homare", "穗希", "龙妈","大仓唯","龙王","紫妈"],
    ...
    1108: ["克萝依", "クロエ", "Kuroe", "克罗依", "华哥", "黑江", "黑江花子", "花子","棒棒糖"],
    ...
    1115: ["克莉丝提娜(圣诞节)", "クリスティーナ(クリスマス)", "Kurisutiina(Xmas)", "Christina(Xmas)", "Cristina(Xmas)", "圣诞克", "圣诞克总", "圣诞女帝", "蛋克", "圣克", "必胜客","蛋壳"],
    ...
    1127: ["铃(游侠)", "リン(レンジャー)", "Rin(Ranger)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠🐿️", "武松","钻头松鼠","钻头哥"],
    ...
    1145: ["咲恋(圣诞节)", "サレン(クリスマス)", "Saren(Xmas)", "圣诞充电宝", "圣电", "圣诞咲恋","圣殿"],
    1146: ["优花梨(圣诞节)", "ユカリ(クリスマス)", "Yukari(Xmas)", "蛋黄", "由加莉(圣诞节)", "圣诞黄骑", "圣诞圣骑", "蛋骑", "黄骑(圣诞节)","圣黄","圣皇"],
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)", "新年511", "春511", "春矛","春11","512"],
    ...
    1160: ["真步(灰姑娘)", "マホ(シンデレラ)", "Maho(Cinderella)", "灰姑娘狐狸", "灰狐狸", "灰狐", "灰壶","茶壶", "茶狐"],
    ...
    1164: ["优妮(圣学祭)","ユニ(聖学祭)","Yuni(Seigakusai)","圣优妮","圣UNI"],
    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八","86"],
    1166: ["嘉夜(时间旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "时间旅行龙拳", "穿越龙拳", "水手龙", "水手龙拳"],
    1167: ["碧(作业服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "碧(工作服)", "工菜", "韭菜", "工作碧","贡菜","榨菜"],
    ...
    1177: ["香织(万圣节)", "カオリ(ハロウィン)", "Kaori(Halloween)", "万圣狗", "瓜狗", "万圣狗拳","尾刀狗"],
    1178: ["妮诺(万圣节)", "ニノン(ハロウィン)", "Ninon(Halloween)", "万圣扇", "瓜扇", "万圣扇子"],
    1179: ["铃奈(万圣节)", "スズナ(ハロウィン)", "Suzuna(Halloween)", "万圣暴弓", "瓜弓", "瓜暴弓", "万圣爆弓", "瓜爆弓"],
    1180: ["克蕾琪塔", "クレジッタ", "Kurejitta", "富婆","资本家","大姬塔","信用卡"],
    1181: ["兰法", "ランファ", "Ranfa", "Ranpha","兰法妈妈"],
    ...
    1193: ["璃乃(圣诞节)", "リノ(クリスマス)", "Rino(Xmas)", "圣诞妹弓", "圣诞璃乃", "弹弓", "蛋弓", "诞弓","寄弓"],
    ...
    1207: ["雪菲(新年)", "シェフィ(ニューイヤー)", "Shephy(NewYear)", "Shefi(NewYear)", "新年雪菲", "春雪菲", "春菲","春龙"],
    ...
    1214: ["美咲(舞台)", "ミサキ(ステージ)", "Misaki(Satge)", "舞台大眼", "舞台眼", "舞台美咲", "车眼","泥头车大眼"],
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "怪盗路人", "怪盗路人妹","怪盗妹"],
    ...
    1808: ["禊&美美&镜华", "ミソギ&ミミ&キョウカ", "Misogi&Mimi&Kyouka", "小小甜心", "狱三家", "小御三家","散装克"],
