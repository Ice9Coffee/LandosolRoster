...
CHARA_NAME = {
    ...
    1272: ["凯留(插班生)", "キャル(編入生)", "Kyaru(Transfer Student)", "学猫", "偷腥猫"],
    ...
    1288: ["怜(星辰)", "レイ(アストラル)", "Rei(Astral)", "怜(星幽)", "星怜", "⭐怜"],
    ...
    1298:["真琴(指挥官)", "マコト(コマンダー)", "Makoto (Commander)", "指狼", "指琴"],
    1299:["惠理子(指挥官)", "エリコ(コマンダー)", "Eriko(Commander)", "病教", "娇官", "指病"],
