...
CHARA_NAME = {
    ...
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "泳装娜娜卡", "泳装77k", "泳装77香", "水娜娜卡", "水77k", "水77香", "水七七香", "泳装七七香", "水七", "水7"],
    ...
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "Chieru(SchoolFestival)", "千爱瑠(圣学祭)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣学祭千爱瑠", "圣爱瑠", "圣切噜"],
    ...
    1235: ["铃(万圣节)", "リン(ハロウィン)", "Rin(Halloween)", "瓜松鼠", "鬼松鼠", "万圣松鼠", "瓜松", "鬼松"],
    1236: ["智(万圣节)", "トモ(ハロウィン)", "Tomo(Halloween)", "瓜智", "鬼智", "万圣智"],
    1237: ["七七香(万圣节)", "ナナカ(ハロウィン)", "Nanaka(Halloween)", "鬼七", "瓜七", "万圣七七香", "鬼泣", "鬼7", "瓜7"],
    ...
    1295: ["琪爱儿(冬日)", "チエル(ウィンター)", "Chieru(Winter)", "千爱瑠(冬日)", "水切噜", "冬切噜", "水切", "冬切"],
    ...
    1320: ["艾姬多娜(夏日)", "エキドナ(サマー)", "Echidna(Summer)", "夏日艾姬多娜", "夏日强欲", "水艾姬多娜", "水强欲", "强欲魔女", "强欲", "魔女"],
    ...
    1328: ["莱拉耶尔(圣诞节)", "ライラエル(クリスマス)", "Lyrael(Christmas)", "Lyrael(Holiday)", "圣莱", "雪莱"],
    1329: ["伊绪(圣诞节)", "イオ(クリスマス)", "Io(Christmas)", "Io(Holiday)", "圣老师", "白老师", "圣魅魔"],
    1330: ["格蕾斯", "グレイス", "Grace", "幽灵妹", "幽灵骑士"],

    1332: ["莫妮卡(新年)", "モニカ(ニューイヤー)", "Monika(NewYear)", "春二力", "新二力", "春莫妮卡", "新莫妮卡", "春毛", "春力"],


    1335: ["咲恋(新年)", "サレン(ニューイヤー)", "Saren(NewYear)", "春咲", "春电"],
    1336: ["美杜莎", "メドゥーサ", "Medusa"],
    1337: ["拉比林斯达(始原)", "ラビリスタ(アルファ)", "Labyrista(Alpha)", "菈比莉斯塔(始原)", "原晶", "α晶"],
    1338: ["似似花(始原)", "ネネカ(アルファ)", "Neneka(Alpha)", "原花", "α花"],
    1339: ["克莉丝提娜(始原)", "クリスティーナ(アルファ)", "Kurisutiina(Alpha)", "原克", "α克"],
    1340: ["菲欧", "フィオ", "Fio"],


    1343: ["兰法(祭服)", "ランファ(儀装束)", "Ranpha(Costume)", "Ranpha(Ceremonial)", "兰法(礼服)", "礼服兰法", "礼兰法", "礼兰"],
    1344: ["千歌(祭服)", "チカ(儀装束)", "Chika(Costume)", "Ranpha(Ceremonial)", "千歌(礼服)", "礼服千歌", "礼千歌", "礼千"],

    1346: ["碧(驾驶员)", "アオイ(パイロット)", "Aoi(pilot)", "机菜", "荠菜", "机碧", "白菜"],
    # =================================== #
...
CHARA_PROFILE = {
    ...
    1297: {"名字": "涅妃涅菈", "公会": "？？？", "生日": "12月31日", "年龄": "？？？", "身高": "139cm", "体重": "？？？kg", "血型": "？", "种族": "妖魔人", "喜好": "过家家、人间观察", "声优": "大久保瑠美"},
    ...
    1330: {"名字": "格蕾斯", "公会": "？？？", "生日": "10月31日", "年龄": "20", "身高": "166cm", "体重": "0kg", "血型": "AB", "种族": "人族", "喜好": "水墨画", "声优": "富田美忧"},
