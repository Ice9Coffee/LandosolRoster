...
CHARA_NAME = {
    ...
    1122: ["霞(魔法少女)", "カスミ(マジカル)", "Kasumi(MagiGirl)", "Kasumi(Magical Girl)", "Kasumi(Magical)", "MGKasumi", "魔法少女霞", "魔法侦探", "魔法杜宾犬", "魔法驴", "魔法驴子", "魔驴", "魔法霞", "魔法少驴"],
    ...
    1360: ["阿刺克涅", "アラクネ", "Arachne", "阿拉克涅", "蜘蛛", "蜘蛛女"],
    ...
    1395: ["莉莉(女武神)", "リリ(ヴァルキュリア)", "Riri(Valkyrie)", "VRiri", "武莉莉", "武莉"],
    1396: ["可璃亚(女武神)", "クリア(ヴァルキュリア)", "Qulia(Valkyrie)", "VPrecia", "武璃亚", "武可", "武盾妹"],
    1397: ["普蕾西亚(女武神)", "プレシア(ヴァルキュリア)", "Precia(Valkyrie)", "VPrecia", "普雷西娅(女武神)", "武猪妹"],
    # =================================== #
...
CHARA_PROFILE = {
    ...
    1369: {"名字": "璐璐伊", "公会": "？？？", "生日": "10月8日", "年龄": "13？", "身高": "148cm", "体重": "？kg", "血型": "青", "种族": "？？？", "喜好": "章鱼料理、赶海挖贝、一个人猜拳", "声优": "饭田光"},
