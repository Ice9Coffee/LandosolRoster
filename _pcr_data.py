...
CHARA_NAME = {
    ...
    1179: ["铃奈(万圣节)", "スズナ(ハロウィン)", "Suzuna(Halloween)", "HSuzuna", "万圣暴弓", "瓜弓", "瓜暴弓", "万圣爆弓", "瓜爆弓", "鬼暴", "鬼暴弓"],
    ...
    1299: ["惠理子(指挥官)", "エリコ(コマンダー)", "Eriko(Commander)", "CoEriko", "惠理子(教官)", "战病", "病教", "娇官", "指病", "军病", "交警", "娇警", "警病"],
    ...
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "Ameth(Summer)", "SAmeth", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝", "水梅斯", "水爱", "水ms"],
    ...
    1811: ["静流&璃乃", "シズル&リノ", "Shizuru&Rino", "ShizuRino", "流璃", "琉璃", "姐妹弓"],
