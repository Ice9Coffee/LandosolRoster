...
CHARA_NAME = {
    ...
    1084: ["千歌(圣诞节)", "チカ(クリスマス)", "Chika(Xmas)", "Chika(Holiday)", "Chika(Christmas)", "XChika", "圣诞千歌", "圣千", "蛋鸽", "🎄💰🎶", "🎄千🎶", "🎄1000🎶"],
    1085: ["胡桃(圣诞节)", "クルミ(クリスマス)", "Kurumi(Xmas)", "Kurumi(Holiday)", "Kurumi(Christmas)", "XKurumi", "圣诞胡桃", "圣诞铃铛", "圣铃"],
    1086: ["绫音(圣诞节)", "アヤネ(クリスマス)", "Ayane(Xmas)", "Ayane(Holiday)", "Ayane(Christmas)", "XAyane", "圣诞熊锤", "蛋锤", "圣锤", "🎄🐻🔨", "🎄🐻"],
    1087: ["日和(新年)", "ヒヨリ(ニューイヤー)", "Hiyori(NewYear)", "NYHiyori", "日和莉(新年)", "新年日和", "春猫", "👘🐱"],
    ...
    1096: ["妮诺(大江户)", "ニノン(オーエド)", "Ninon(Ooedo)", "ONinon", "妮侬(大江户)", "江户扇子", "忍扇"],
    ...
    1112: ["禊(万圣节)", "ミソギ(ハロウィン)", "Misogi(Halloween)", "HMisogi", "未奏希(万圣节)", "万圣禊", "万圣炸弹人", "瓜炸弹人", "万圣炸弹", "万圣炸", "瓜炸", "南瓜炸", "万圣节禊", "万圣熊孩", "🎃💣"],
    1113: ["美美(万圣节)", "ミミ(ハロウィン)", "Mimi(Halloween)", "HMimi", "万圣兔", "万圣兔子", "万圣兔兔", "绷带兔", "绷带兔子", "万圣美美", "绷带美美", "瓜兔", "万圣🐰", "绷带🐰", "🎃🐰", "万圣🐇", "绷带🐇", "🎃🐇"],
    1114: ["露娜", "ルナ", "Runa", "Luna", "露仓唯", "露cw"],
    1115: ["克莉丝提娜(圣诞节)", "クリスティーナ(クリスマス)", "Kurisutiina(Xmas)", "Christina(Xmas)", "Cristina(Xmas)", "Christina(Holiday)", "Christina(Christmas)", "XChristina", "圣诞克", "圣诞克总", "圣诞女帝", "蛋克", "蛋壳", "圣克", "必胜客"],
    1116: ["望(圣诞节)", "ノゾミ(クリスマス)", "Nozomi(Xmas)", "Nozomi(Holiday)", "Nozomi(Christmas)", "XNozomi", "圣诞望", "圣诞偶像", "蛋偶像", "蛋望", "圣望"],
    1117: ["伊莉亚(圣诞节)", "イリヤ(クリスマス)", "Iriya(Xmas)", "Illya(Holiday)", "Illya(Christmas)", "XIllya", "圣诞伊莉亚", "圣诞伊利亚", "圣诞伊莉雅", "圣诞伊利雅", "圣诞yly", "圣诞吸血鬼", "圣伊", "圣yly", "伊利丹"],
    ...
    1122: ["霞(魔法少女)", "カスミ(マジカル)", "Kasumi(MagiGirl)", "Kasumi(Magical Girl)", "Kasumi(Magical)", "MGKasumi", "香澄(魔法少女)", "魔法少女霞", "魔法侦探", "魔法杜宾犬", "魔法驴", "魔法驴子", "魔驴", "魔法霞", "魔法少驴"],
    1123: ["栞(魔法少女)", "シオリ(マジカル)", "Shiori(MagiGirl)", "Shiori(Magical Girl)", "Shiori(Magical)", "MGShiori", "魔法少女栞", "魔法tp弓", "魔法小栞", "魔法白虎弓", "魔法白虎妹", "魔法白虎", "魔栞", "魔弓", "魔法弓", "法弓"],
    ...
    1127: ["铃(游侠)", "リン(レンジャー)", "Rin(Ranger)", "RRin", "铃(游骑兵)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠🐿️", "武松", "钻头松鼠"],
    1128: ["真阳(游侠)", "マヒル(レンジャー)", "Mahiru(Ranger)", "RMahiru", "真阳(游骑兵)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "游侠🐄", "游侠🐮", "牛叉"],
    ...
    1142: ["莫妮卡(魔法少女)", "モニカ(マジカル)", "Monika(MagiGirl)", "Monika(Magical Girl)", "MGMonika", "魔法少女莫妮卡", "魔二力", "魔卡少女"],
    1143: ["智(魔法少女)", "トモ(マジカル)", "Tomo(MagiGirl)", "Tomo(Magical Girl)", "MGTomo", "魔法少女智", "琪露诺", "9智", "⑨", "魔智"],
    1144: ["秋乃(圣诞节)", "アキノ(クリスマス)", "Akino(Xmas)", "Akino(Christmas)", "XAkino", "圣剑", "生煎", "圣诞哈哈剑", "哈哈剑(圣诞节)", "圣哈", "蛋哈", "蛋剑"],
    1145: ["咲恋(圣诞节)", "サレン(クリスマス)", "Saren(Xmas)", "Saren(Christmas)", "XSaren", "圣诞充电宝", "圣电", "圣诞咲恋"],
    1146: ["优花梨(圣诞节)", "ユカリ(クリスマス)", "Yukari(Xmas)", "Yukari(Christmas)", "XYukari", "蛋黄", "由加莉(圣诞节)", "圣诞黄骑", "圣诞圣骑", "蛋骑", "黄骑(圣诞节)", "圣黄"],
    ...
    1192: ["真阳(圣诞节)", "マヒル(クリスマス)", "Mahiru(Xmas)", "Mahiru(Holiday)", "Mahiru(Christmas)", "XMahiru", "圣牛", "蛋牛", "圣诞奶牛", "圣诞牛"],
    1193: ["璃乃(圣诞节)", "リノ(クリスマス)", "Rino(Xmas)", "Rino(Holiday)", "Rino(Christmas)", "XRino", "圣诞妹弓", "圣诞璃乃", "弹弓", "蛋弓", "诞弓"],





    1199: ["宫子(圣诞节)", "ミヤコ(クリスマス)", "Miyako(Xmas)", "Miyako(Holiday)", "Miyako(Christmas)", "XMiyako", "圣诞布丁", "圣诞宫子", "诞丁", "蛋丁", "但丁"],
    ...
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "Ayumi(PhantomThief)", "PTAyumi", "步美(怪盗)", "怪盗路人", "怪盗路人妹", "怪盗妹"],
    ...
    1240: ["茜里(圣诞节)", "アカリ(クリスマス)", "Akari(Xmas)", "Akari(Holiday)", "Akari(Christmas)", "XAkari", "圣妹", "圣诞妹法"],
    1241: ["依里(圣诞节)", "ヨリ(クリスマス)", "Yori(Xmas)", "Yori(Holiday)", "Yori(Christmas)", "XYori", "圣姐", "圣诞姐法"],
    1242: ["纯(圣诞节)", "ジュン(クリスマス)", "Jun(Xmas)", "Jun(Holiday)", "Jun(Christmas)", "XJun", "白骑", "圣黑骑", "圣诞黑骑"],
    ...
    1260: ["可璃亚(堕落)", "クリア(フォールン)", "Qualia(Fallen)", "Quria(Fallen)", "Qulia(Fallen)", "FQuria", "可璃亚(堕天使)", "可璃亚", "盾妹"],
    ...
    1297: ["涅妃‧涅罗", "ネフィ＝ネラ", "Nephi-Nera", "Nephi＝Nela", "Nefi=Nera", "Nephi Nela", "涅妃＝涅菈", "涅妃"],
    ...
    1310: ["真步(梦想乐园)", "マホ(ドリームパーク)", "Maho(DreamPark)", "DPMaho", "梦狐", "烧狐", "兔狐"],
    ...
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "Ameth(Summer)", "SAmeth", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝", "水梅斯", "水爱", "水ms", "水ams"],
    1318: ["帆稀(夏日)", "ホマレ(サマー)", "Homare(Summer)", "SHomare", "水龙妈", "夏日龙妈"],
    1319: ["爱蜜莉雅(夏日)", "エミリア(サマー)", "Emiria(Summer)", "SEmilia", "夏日艾米莉亚", "水emt", "水艾米", "水爱蜜", "夏日emt", "水莉雅", "smt"],
    ...
    1323: ["露易丝玛莉", "ルイズマリー", "Louise-Marie", "露易丝玛丽", "鹿妹", "涩鹿", "🦌"],
    1324: ["彩羽", "イロハ", "Iroha", "伊吕波"],
    1325: ["苑", "ソノ", "Sono"],


    1328: ["莱拉耶尔(圣诞节)", "ライラエル(クリスマス)", "Lyrael(Christmas)", "Lyrael(Holiday)", "XLyrael", "圣莱", "雪莱", "火莱", "火莱拉"],
    1329: ["伊绪(圣诞节)", "イオ(クリスマス)", "Io(Christmas)", "Io(Holiday)", "XIo", "圣老师", "白老师", "圣魅魔"],
    1330: ["格蕾斯", "グレイス", "Grace", "格蕾丝", "幽灵妹", "幽灵骑士"],
    1331: ["薇欧莉特", "ヴァイオレット", "Violet", "薇奥莉特", "紫罗兰", "薇尔莉特", "堇", "石块妹"],
    ...
    1345: ["克萝茜(航空)", "クローチェ(エアリアル)", "Croce(Aerial)", "Croche(Aerial)", "ACroce", "克萝茜(空战)", "火机", "火鸡", "飞机"],
    ...
    1358: ["雪野", "ユキノ", "Yukino", "雪乃", "雪女"],
    1359: ["刹鬼", "サツキ", "Satsuki", "沙月", "鬼娘", "鬼萝莉", "鬼妹", "皐月"],
    1360: ["阿剌克涅", "アラクネ", "Arachne", "阿拉克涅", "蜘蛛", "蜘蛛女"],
    1361: ["樱", "サクラ", "Sakura", "源樱", "肉樱"],
    1362: ["拿娜", "ナーナ", "Naana", "纳娜"],
    1363: ["美空(圣诞节)", "ミソラ(クリスマス)", "Misora(Holiday)", "Misora(Christmas)", "圣美空", "圣诞美空"],
    1364: ["优衣(圣诞节)", "ユイ(クリスマス)", "Yui(Holiday)", "Yui(Christmas)", "圣田", "圣衣", "圣UE", "圣优衣", "圣诞优衣"],
    1365: ["静流(新年)", "シズル(ニューイヤー)", "Shizuru(NewYear)", "NYShizuru", "春姐"],



    1369: ["璐璐伊", "ルルィ", "Rurui", "章鱼妹", "章鱼", "露露伊"],

    1371: ["妮诺(夏日)", "ニノン(サマー)", "Ninon(Summer)", "SNinon", "妮侬(夏日)", "水扇子", "水扇"],


    1374: ["霞(修女)", "カスミ(シスター)", "Kasumi(Sister)", "SisKasumi", "香澄(修女)", "修女驴", "修女霞", "修驴"],

    1376: ["可可萝(向导幼君)", "コッコロ(嚮導幼君)", "Kokkoro(Little Guidance)", "LGKokkoro", "导可", "大可", "导妈"],


    1379: ["璃乃(新年)", "リノ(ニューイヤー)", "Rino(NewYear)", "NYRino", "春弓", "春妹弓"],
    1380: ["薇欧莉特(黄泉鲸命)", "ヴァイオレット(イサナミ)", "Violet(Isanami)", "IViolet", "薇欧莉特(伊邪那美)", "薇奥莉特(伊邪那美)", "水紫罗兰", "水紫"],
    1381: ["莱拉耶尔(完美帕菲)", "ライラエル(パルフェクト)", "Lyrael(Perfect)", "PLyrael", "莱拉耶尔(完美)", "完莱", "风莱"],
    1382: ["涅妃‧涅罗(鬼面佛心)", "ネフィ＝ネラ(鬼面仏心)", "Nephi=Nella(Buddha)", "Nephi Nela(Buddha)", "BNefi", "BNefi=Nera", "涅妃＝涅菈(鬼面佛心)", "鬼妃", "佛妃", "鬼涅", "佛涅"],
    ...
    1390: ["镜华(哥德)", "キョウカ(ゴシック)", "Kyouka(Gothic)", "GKyouka", "镜华(哥特)", "哥唯", "哥特唯", "暗唯", "黑唯", "gcw", "暗cw", "哥cw"],
    1391: ["凯留(霸瞳天星)", "キャル(霸瞳天星)", "Kyaru(Hadou Tensei)", "KKyaru", "凯露(霸瞳天星)", "霸猫", "天星猫"],
    1392: ["美穗(少战)", "ミホ(ガルパン)", "Miho(Garupan)", "GPMiho", "美穗", "西住军神", "军神"],
    1393: ["真穗(少战)", "マホ(ガルパン)", "Maho(Garupan)", "GPMaho", "真穗", "西住姐"],
    1394: ["艾丽卡(少战)", "エリカ(ガルパン)", "Erika(Garupan)", "GPErika", "艾丽卡"],
    1395: ["莉莉(女武神)", "リリ(ヴァルキュリア)", "Riri(Valkyrie)", "VRiri", "武莉莉", "武莉", "神莉莉"],
    1396: ["可璃亚(女武神)", "クリア(ヴァルキュリア)", "Qulia(Valkyrie)", "VQulia", "VQuria", "武璃亚", "武可", "武盾妹", "神盾妹"],
    1397: ["普蕾西亚(女武神)", "プレシア(ヴァルキュリア)", "Precia(Valkyrie)", "VPrecia", "普雷西娅(女武神)", "武猪妹", "神猪妹"],
    1398: ["雪菲(真龙)", "シェフィ(ヴァードラッヘ)", "Sheffy(Wahrer Drache)", "WDSheffy", "龙菲", "龙雪", "龙雪菲", "王雪菲", "暗雪菲"],
    1399: ["露易丝玛莉(夏日)", "ルイズマリー(サマー)", "Louise-Marie(Summer)", "露易丝玛丽(夏日)", "水鹿", "水鹿妹"],
    1400: ["克蕾琪塔(夏日)", "クレジッタ(サマー)", "Creditta(Summer)", "SCreditta", "水富婆", "水婆"],
    1401: ["布武机(夏日)", "フブキ(サマー)", "Fubuki(Summer)", "SFubuki", "吹雪(夏日)", "水吹雪", "水小鬼"],
    1402: ["斑比(夏日)", "ヴァンピィ(サマー)", "Vampy(Summer)", "SVampy", "水斑比"],
    1403: ["媞雅", "ティア", "Tia", "蒂亚"],
    1404: ["黎萨", "リーザ", "Lisa", "丽莎"],
    1405: ["乌尔姆(真龙)", "ヴルム(ヴァルムドラッヘ)", "Wurm(Warmdrache)", "WDWurm", "维尔姆(真龙)"],
    1406: ["克萝茜(潜航)", "クローチェ(サブマリン)", "Croce(Submarine)", "SCroce", "水机娘", "水机"],
    # =================================== #
...
CHARA_PROFILE = {
    ...
    1068: {"名字": "拉比林斯达", "公会": "拉比林斯", "生日": "7月25日", "年龄": "25", "身高": "160cm", "体重": "？？？kg", "血型": "AB", "种族": "人族", "喜好": "观察人类", "声优": "泽城美雪", "称号": "秘密结社拉比林斯的「迷宫女王」"},
    ...
    1186: {"名字": "涅比亚", "公会": "？？？", "生日": "？月？日", "年龄": "？？？", "身高": "？cm", "体重": "？？？kg", "血型": "？", "种族": "？？？", "喜好": "恶作剧", "声优": "相坂优歌", "称号": "在幻雾玩耍的爱恶作剧向导小妖精"},
    ...
    1290: {"名字": "厄莉丝", "公会": "？？？", "生日": "2月15日", "年龄": "？？？", "身高": "168cm", "体重": "？？？kg", "血型": "？", "种族": "人族", "喜好": "听骑士君说话", "声优": "桑島法子"},
    1296: {"名字": "安涅默涅", "公会": "吉欧·格黑纳", "生日": "4月2日", "年龄": "13", "身高": "145cm", "体重": "39kg", "血型": "A", "种族": "妖魔人", "喜好": "打理花、拔刺", "声优": "立花日菜"},
    1297: {"名字": "涅妃‧涅罗", "公会": "吉欧·格黑纳", "生日": "12月31日", "年龄": "？？？", "身高": "139cm", "体重": "？？？kg", "血型": "？", "种族": "妖魔人", "喜好": "过家家、人间观察", "声优": "大久保瑠美"},
    ...
    1360: {"名字": "阿剌克涅", "公会": "吉欧·格黑纳", "生日": "1月15日", "年龄": "28", "身高": "240cm", "体重": "108kg", "血型": "AB", "种族": "妖魔人", "喜好": "追逐光明、整理收拾", "声优": "远藤绫"},
    ...
    1369: {"名字": "璐璐伊", "公会": "吉欧·尼布尔黑尔", "生日": "10月8日", "年龄": "13？", "身高": "148cm", "体重": "？kg", "血型": "青", "种族": "？？？", "喜好": "章鱼料理、赶海挖贝、一个人猜拳", "声优": "饭田光"},
    ...
    1403: {"名字": "媞雅", "公会": "？？？", "生日": "2月15日", "年龄": "？？？", "身高": "150cm", "体重": "？kg", "血型": "？", "种族": "？？？", "喜好": "出谜题", "声优": "高田忧希"},
    1404: {"名字": "黎萨", "公会": "？？？", "生日": "12月17日", "年龄": "19", "身高": "163cm", "体重": "48kg", "血型": "AB", "种族": "暗精灵族", "喜好": "学习药学、遛狗", "声优": "若山诗音"},
}