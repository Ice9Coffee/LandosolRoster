...
SpecialType = {
    "FES":[1801, 1802, 1803, 1804, 1805, 1806, 1807, 1808, 1809, 1061, 1067, 1068, 1070, 1071, 1181, 1900],
    "兑换":[1185, 1069],
    "联动":[1701, 1702, 1099, 1097, 1098, 1124, 1125, 1126]
}
...
CHARA_NAME = {
    ...
    1005: ["茉莉", "マツリ", "Matsuri", "跳跳虎", "老虎", "虎", "跳刀虎", "马自立"],
    1006: ["茜里", "アカリ", "Akari", "妹法", "阿卡丽", "妹妹法", "车王"],
    ...
    1020: ["美美", "ミミ", "Mimi", "兔子", "兔", "兔兔", "兔剑", "萝卜霸断剑", "人参霸断剑", "天兔霸断剑"],
    ...
    1034: ["优花梨", "ユカリ", "Yukari", "由加莉", "黄骑", "酒鬼", "奶骑", "油咖喱"],
    ...
    1075: ["贪吃佩可(夏日)", "ペコリーヌ(サマー)", "Pecorine(Summer)", "Pekoriinu(Summer)", "佩可莉姆(夏日)", "水吃", "水饭", "水吃货", "水佩可", "水公主", "水饭团", "泳吃", "泳饭", "泳吃货", "泳佩可", "泳公主", "泳饭团", "泳装吃货", "泳装公主", "泳装饭团", "佩可(夏日)","泼妇"],
    1076: ["可可萝(夏日)", "コッコロ(サマー)", "Kokkoro(Summer)", "水白", "水妈", "水可", "水可可", "水可可萝", "水可可罗", "泳装妈", "泳装可可萝", "泳装可可罗"],
    1077: ["铃莓(夏日)", "スズメ(サマー)", "Suzume(Summer)", "水女仆", "水妹抖"],
    1078: ["凯留(夏日)", "キャル(サマー)", "Karyl(Summer)", "Kyaru(Summer)", "凯露(夏日)", "水黑", "水黑猫", "水臭鼬", "泳装黑猫", "泳装臭鼬", "潶", "溴",  "流泪猫猫头"],
    1079: ["珠希(夏日)", "タマキ(サマー)", "Tamaki(Summer)", "水猫剑", "水猫", "渵", "夏日朱希"],
    1080: ["美冬(夏日)", "ミフユ(サマー)", "Mifuyu(Summer)", "水子龙", "水美冬", "夏日美冬", "夏日子龙"],
    1081: ["忍(万圣节)", "シノブ(ハロウィン)", "Shinobu(Halloween)", "万圣忍", "瓜忍", "鬼忍"],
    1082: ["宫子(万圣节)", "ミヤコ(ハロウィン)", "Miyako(Halloween)", "万圣宫子", "万圣布丁", "狼丁", "狼布丁"],
    1083: ["美咲(万圣节)", "ミサキ(ハロウィン)", "Misaki(Halloween)", "万圣美咲", "万圣大眼", "瓜眼"],
    1084: ["千歌(圣诞节)", "チカ(クリスマス)", "Chika(Xmas)", "圣诞千歌", "圣千", "蛋鸽"],
    1085: ["胡桃(圣诞节)", "クルミ(クリスマス)", "Kurumi(Xmas)", "圣诞胡桃", "圣诞铃铛", "圣铃"],
    1086: ["绫音(圣诞节)", "アヤネ(クリスマス)", "Ayane(Xmas)", "圣诞熊锤", "蛋锤", "圣锤"],
    1087: ["日和(新年)", "ヒヨリ(ニューイヤー)", "Hiyori(NewYear)", "新年日和", "春猫", "新年猫拳"],
    ...
    1104: ["真琴(夏日)", "マコト(サマー)", "Makoto(Summer)", "水狼", "浪","泳狼", "泳月", "泳月月", "泳朋", "水月", "水月月", "水朋"],
    1105: ["香织(夏日)", "カオリ(サマー)", "Kaori(Summer)", "水狗", "泃", "水🐕", "泳狗", "水狗拳"],
    1106: ["真步(夏日)", "マホ(サマー)", "Maho(Summer)", "水狐狸", "水狐", "水壶", "水真步", "水maho"],
    ...
    1124: ["卯月(NGs)", "ウヅキ(デレマス)", "Udsuki(DEREM@S)", "卯月(偶像大师)", "卯月", "Udsuki(DEREMAS)", "岛村卯月", "Udsuki"],
    ...
    1128: ["真阳(游侠)", "マヒル(レンジャー)", "Mahiru(Ranger)", "骑兵奶牛", "游侠奶牛", "游骑兵奶牛", "护林员奶牛", "护林奶牛", "牛叉"],
    ...
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "万圣蜘蛛侠", "万裁", "瓜裁", "鬼裁", "鬼才"],
    ...
    1171: ["静流(夏日)", "シズル(サマー)", "Shizuru(Summer)", "泳装静流", "泳装姐姐", "水姐", "水姐姐", "水解", "水静流", "水静"],
    ...
    1180: ["克蕾琪塔", "クレジッタ", "Kurejitta", "富婆", "信用卡", "哈哈钱", "奸商", "大姬塔", "资本家"],
    ...
    1185: ["花凛", "カリン", "Karin", "佳凛", "绿色恶魔", "绿魔", "绿毛恶魔", "眼镜", "可恶眼镜"],
    ...
    1210: ["贪吃佩可(超载)", "ペコリーヌ(オーバーロード)", "Pecorine(Overload)", "Pekoriinu(Overload)", "超载吃", "超吃", "超载佩可", "超载佩", "超佩", "破败王"],
    1211: ["凯留(超载)", "キャル(オーバーロード)", "Karyl(Overload)", "凯露(超载)", "Kyaru(Overload)", "超载凯留", "超凯留", "超载黑猫", "超黑", "超猫", "超威蓝猫", "电猫"],
    1212: ["拉比林斯达(超载)", "ラビリスタ(オーバーロード)", "Labyrista(Overload)", "Rabirisuta(Overload)", "超载晶", "超晶"],
    1213: ["胡桃(舞台)", "クルミ(ステージ)", "Kurumi(Stage)", "舞台胡桃", "舞桃", "演员", "舞胡", "芜湖", "舞铃", "舞台铃", "戏铃", "台铃", "孕妇"],
    ...
    1222: ["优花梨(露营)", "ユカリ(キャンプ)", "Yukari(Camp)", "露营优花梨", "露优花梨", "露花梨", "露营黄骑", "露黄骑", "露黄", "野骑", "野鬼", "露由", "蒂骑"],
    1223: ["斑比", "ヴァンピィ", "Vampy", "Vania", "斑比酱", "钉宫", "8B", "813"],
    1224: ["日和(夏日)", "ヒヨリ(サマー)", "Hiyori(Summer)", "水猫拳", "水日和", "海猫"],
    1225: ["怜(夏日)", "レイ(サマー)", "Rei(Summer)", "水怜", "水剑圣", "水帘洞"],
...
CHARA_PROFILE = {
    ...
    1065: {"名字": "嘉夜", "公会": "龙族据点", "生日": "6月25日", "年龄": "16", "身高": "156cm", "体重": "？？？kg", "血型": "B", "种族": "龙人族", "喜好": "格斗技", "声优": "小市真琴", "称号": "笨蛋打架狂"},
    1066: {"名字": "祈梨", "公会": "龙族据点", "生日": "9月29日", "年龄": "13", "身高": "145cm", "体重": "？？？kg", "血型": "AB", "种族": "龙人族", "喜好": "游戏", "声优": "藤田茜", "特技": "龙之吐息", "职位": "干部"},
    1067: {"名字": "帆稀", "公会": "龙族据点", "生日": "4月17日", "年龄": "25", "身高": "168cm", "体重": "？？？kg", "血型": "O", "种族": "龙族", "喜好": "绘画、读书", "声优": "大西沙织", "称号": "卧龙头领"},
    ...
    1109: {"名字": "千爱瑠", "公会": "圣特蕾莎女子学院(好朋友社)", "生日": "9月15日", "年龄": "16", "身高": "156cm", "体重": "46kg", "血型": "O", "种族": "人族", "喜好": "跳舞、卡拉OK", "声优": "佐仓绫音", "切嚕唎咧咧囉唎囉唎囉": "咧切嚕切嚕啵啪嗶", "称号": "圣德蕾女的狂人"},
