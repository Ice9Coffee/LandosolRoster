...
CHARA_NAME = {
    ...
    1069: ["霸瞳皇帝", "マナ", "Mana", "Kaiser Insight", "真那", "千里真那", "千里", "霸瞳", "霸铜"],
    ...
    1165: ["祈梨(时空旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "Inori(TimeTraveller)", "TTInori", "祈梨(时间旅行)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八"],
    ...
    1168: ["珠希(工作服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "Tamaki(Work)", "WTamaki", "珠希(作业服)", "工猫贼", "工猫剑", "工贼", "工珠希"],
    ...
    1222: ["优花梨(露营)", "ユカリ(キャンプ)", "Yukari(Camp)", "CYukari", "由加莉(露营)", "露营优花梨", "露优花梨", "露花梨", "露营黄骑", "露黄骑", "露黄", "野黄"],
    ...
    1255: ["吉塔(术士)", "ジータ(ウォーロック)", "Djeeta(Warlock)", "WDjeeta", "姬塔(术士)", "魔姬", "魔吉", "魔法姬塔", "魔法吉他", "魔塔", "法吉", "法鸡"],
    ...
    1262: ["伊莉亚(祭服)", "イリヤ(儀装束)", "Ilya(Costume)", "Illya(Ceremonial)", "CIllya", "伊莉亚(礼服)", "礼装伊莉亚", "礼装伊莉雅", "礼装伊利亚", "礼装yly", "礼服伊莉亚", "礼服伊莉雅", "礼服伊利亚", "礼服yly", "礼亚", "仪莉亚"],
    ...
    1268: ["优花梨(夏日)", "ユカリ(サマー)", "Yukari(Summer)", "SYukari", "由加莉(夏日)", "水黄", "泳装黄骑", "泳装酒鬼"],
    ...
    1276: ["流夏(萨拉萨利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "SaRuka", "流夏(沙漠)", "流沙", "沙漠流夏"],
    1277: ["琳德", "リンド", "Lind", "龙姐"],
    ...
    1310: ["真步(梦想乐园)", "マホ(ドリームパーク)", "Maho(DreamPark)", "DPMaho", "梦狐"],
    ...
    1337: ["拉比林斯达(始源)", "ラビリスタ(アルファ)", "Labyrista(Alpha)", "ALabyrista", "菈比莉斯塔(始源)", "原晶", "α晶", "阿晶"],
    1338: ["似似花(始源)", "ネネカ(アルファ)", "Neneka(Alpha)", "ANeneka", "原花", "α花", "阿花"],
    1339: ["克莉丝提娜(始源)", "クリスティーナ(アルファ)", "Kurisutiina(Alpha)", "AChristina", "原克", "α克", "阿克"],
    1340: ["菲欧", "フィオ", "Fio"],
    ...
    1345: ["克萝茜(航空)", "クローチェ(エアリアル)", "Croce(Aerial)", "Croche(Aerial)", "ACroche", "克萝茜(风灵)", "火机", "火鸡", "飞机"],
    ...
    1350: ["厄莉丝(夏日)", "エリス(サマー)", "Eris(Summer)", "SEris", "厄里斯(夏日)", "水厄里斯", "水厄", "水els"],
    ...
    1357: ["日和莉(萨拉萨利亚)", "ヒヨリ(サラサリア)", "Hiyori(Salasaria)", "SaHiyori", "日和莉(沙漠)", "沙猫拳", "沙猫"],
    1358: ["雪野", "ユキノ", "Yukino", "雪女", "雪乃"],
    1359: ["刹鬼", "サツキ", "Satsuki", "鬼娘", "鬼萝莉", "鬼妹", "皐月"],
    1360: ["阿刺克涅", "アラクネ", "Arache", "蜘蛛", "蜘蛛女"],
    ...
    1376: ["可可萝(向导幼君)", "コッコロ(嚮導幼君)", "Kokkoro(Big Kok)", "导可", "大可", "导妈"],
