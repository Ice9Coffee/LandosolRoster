...
CHARA_NAME = {
    ...
    1207: ["雪菲(新年)", "シェフィ(ニューイヤー)", "Shephy(NewYear)", "Shefi(NewYear)", "新年雪菲", "春雪菲", "春菲"],
    1208: ["流夏(新年)", "ルカ(ニューイヤー)", "Ruka(NewYear)", "春流夏"],
    1209: ["伊莉亚(新年)", "イリヤ(ニューイヤー)", "Iriya(NewYear)", "新年伊莉亚", "新年伊利亚", "新年伊莉雅", "新年伊利雅", "新年yly", "新年吸血鬼", "春伊", "春yly"],
    ...
    1213: ["胡桃(舞台)", "クルミ(ステージ)", "Kurumi(Stage)", "舞台胡桃", "舞桃", "演员"],
    1214: ["美咲(舞台)", "ミサキ(ステージ)", "Misaki(Satge)", "舞台大眼", "舞台眼", "舞台美咲", "车眼"],
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "怪盗路人", "怪盗路人妹"],
    1216: ["祈梨(怪盗)", "イノリ(怪盗)", "Inori(Kaitou)", "怪盗祈梨", "怪盗龙锤"],
    1217: ["秋乃(秋乃&咲恋)", "アキノ(アキノ&サレン)", "Akino(Akino&Saren)"],
    1218: ["咲恋(秋乃&咲恋)", "サレン(アキノ&サレン)", "Saren(Akino&Saren)"],

    1220: ["忍(海盗)", "シノブ(パイレーツ)", "Shinobu(Pirates)", "海盗忍", "海贼忍"],
    ...
    1809: ["秋乃&咲恋", "アキノ&サレン", "Akino&Saren", "咲哈哈", "哈哈电"],
