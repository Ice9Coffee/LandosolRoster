...
CHARA_NAME = {
    ...
    1257: ["花凛(炼金术士)", "カリン(アルケミスト)", "Karin(Alchemist)", "绿术", "绿发术士", "炼金恶魔", "魔绿"],
    1258: ["莉莉(堕天使)", "リリ(フォールン)", "Riri(Fallen)", "莉莉"],

    1260: ["可璃亚(堕天使)", "クリア(フォールン)", "Quria(Fallen)", "可璃亚"],
    1261: ["普蕾西亚(堕天使)", "プレシア(フォールン)", "Precia(Fallen)", "普雷西娅(堕天使)", "普蕾西亚", "猪妹"],
    ...
    1298:["真琴(教官)", "マコト(コマンダー)", "Makoto(Commander)", "战狼"],
    1299:["惠理子(教官)", "エリコ(コマンダー)", "Eriko(Commander)", "战病", "病教"],
    ...
    1811: ["静流&璃乃", "シズル&リノ", "Shizuru&Rino", "流璃", "琉璃", "姐妹弓"],
