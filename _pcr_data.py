...
CHARA_NAME = {
    ...
    1130: ["步未(奇幻)", "アユミ(ワンダー)", "Ayumi(Wonder)", "步未(奇境)", "步未(仙境)", "路人兔", "兔人妹", "爱丽丝路人", "奇境路人", "奇幻路人", "奇幻步未", "仙境路人", "爱丽丝路人妹", "梦路", "步美(仙境)"],
    ...
    1230: ["爱梅斯", "アメス", "Amesu", "ams", "菲欧", "爱美斯", "艾美斯", "艾梅斯"],
    ...
    1317: ["爱梅斯(夏日)", "アメス(サマー)", "Amesu(Summer)", "水爱梅斯", "sms", "夏日爱梅斯", "水爱梅丝", "夏日爱梅丝"],
    1318: ["帆稀(夏日)", "ホマレ(サマー)", "Homare(Summer)", "水龙妈", "夏日龙妈"],
    1319: ["爱蜜莉雅(夏日)", "エミリア(サマー)", "Emiria(Summer)", "夏日艾米莉亚", "水emt", "水艾米", "水爱蜜", "夏日emt"],
    1320: ["艾姬多娜(夏日)", "エキドナ(サマー)", "Echidna(Summer)", "夏日艾姬多娜", "夏日强欲", "水艾姬多娜", "水强欲"],
    ...
    1812: ["雪菲(公主)", "シェフィ(プリンセス)", "Shephy(Princess)", "公主雪菲", "公冰", " 公雪", "公主冰龙"],
